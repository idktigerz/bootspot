...
if(!isset($_SESSION["username"])) {
	...
	if(isset($_GET['id'])){
	$id=$_GET['id'];
	$sql = "SELECT modelos.nome, modelos.tipoSola, modelos.id as id, marcas.nomes as marcas_nome, produtos.preco as preco, produtos.stock as stock, modelos_foto.image as foto FROM modelos 
	INNER JOIN marcas INNER JOIN produtos INNER JOIN modelos_foto INNER JOIN utilizadores
	WHERE modelos.idMarcas = marcas.id AND modelos.id = produtos.idModelos AND modelos.id = modelos_foto.idModelos AND modelos.id='$id' LIMIT 1";
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<ul class="nav navbar-nav navbar-right">
                            <li class="nav-item"><a class="cart" href="cart.php"><span class="ti-bag"></span></a></li>
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
											...
											<?php 
												...
												WHERE modelos.id = modelos_foto.idModelos AND modelos.id='$id' LIMIT 1";
								...
								<td>
							            ...
							            ?>
                                            <p><?php echo $row['marcas_nome']." ". $row['nome']. " " .$row['tipoSola']; ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <h5 id = "subtotal"><?php echo $row['preco'];?>€</h5>
                                ...
                                <td>
                                    <h5 id = "total"><?php echo $row['preco'];?>€</h5>
                                </td>
                            <tr>
                                <td>
                                </td>
                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner d-flex align-items-center">
                                        <a class="gray_btn" href="category.php">Ver outras opções</a>
                                        <a class="primary-btn" href="checkout.php?idProduto=<?php echo $row['id']; ?>&username=<?php echo $_SESSION['username'];?>">Checkout</a>
                                        <?php
                                            }
                                            ?>   
                                    </div>
