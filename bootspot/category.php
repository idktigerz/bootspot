		...
		<div class='row'>
			<div class='col-xl-3 col-lg-4 col-md-5'>
				<div class='sidebar-categories'>
					...
					<ul class='main-categories'>
						<li class='filter-list'><input class='pixel-radio' type='radio' id='pele_sintetica' name='brand'><label for='pele_sintetica'>Pele sintética<span>(29)</span></label></li>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='pele_natural' name='brand'><label for='pele_natural'>Pele Natural<span>(29)</span></label></li>
					</ul>
				</div>
					...
					<div class='common-filter'>
						...
						<form action='#'>
							<ul>
								...
								<li class='filter-list'><input class='pixel-radio' type='radio' id='new_balance' name='brand'><label for='new_balance'>New Balance<span>(19)</span></label></li>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='under_armour' name='brand'><label for='under_armour'>Under Armour<span>(19)</span></label></li>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='umbro' name='brand'><label for='umbro'>Umbro</label><span>(19)</span></label></li>
							</ul>
						</form>
					</div>
					<div class='common-filter'>
						...
						<form action='#'>
							<ul>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='sintetico' name='color'><label for='sintetico'>Para Sintético<span>(29)</span></label></li>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='relvado' name='color'><label for='relvado'>Para Relvado<span>(29)</span></label></li>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='pitons_aluminio' name='color'><label for='pitons_aluminio'>Pitõns de Aluminio<span>(19)</span></label></li>
							</ul>
						</form>
					</div>
			...
			<div class='col-xl-9 col-lg-8 col-md-7'>
				...
				require("db_connection.php");
					...
					WHERE modelos.idMarcas = marcas.id AND modelos.id = produtos.idModelos AND modelos.id = modelos_foto.idModelos GROUP BY modelos.id ORDER BY RAND(modelos.id)";
