	...
	<div class='container'>
		<div class='row'>
			<div class='col-xl-3 col-lg-4 col-md-5'>
				...
				<div class='sidebar-filter mt-50'>
					<div class='common-filter'>
						...
						<form action='#'>
							<ul>
								<li class='filter-list'><input class='pixel-radio' type='radio' id='new_balance' name='brand' checked><label for='umbro'>Umbro<span>
									</span></label></li>
							</ul>
						</form>
					</div>
			...
			<div class='col-xl-9 col-lg-8 col-md-7'>
				...
				WHERE modelos.idMarcas = marcas.id AND modelos.id = produtos.idModelos AND modelos.id = modelos_foto.idModelos AND marcas.id = 6 GROUP BY modelos.id ORDER BY RAND(modelos.id)";
